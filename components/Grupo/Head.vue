<template>
    ...
    <div v-if="pagePolnacGroup !== null" :class="{'bg-grupo': windowSize > 1129, 'bg-grupo-mb': windowSize < 1129 }" >
        <v-row justify="center">
            <v-col cols="8" align="center" class="mt-16">
                ...
                <h1 class="mt-5 font-archivo font-size-40 white--text font-weight-bold" v-html="pagePolnacGroup.banner.title"></h1>
                ...
                <div class="title white--text mt-8 mb-16" v-html="pagePolnacGroup.banner.subtitle"></div>
...
.bg-grupo-mb{
    background-image: url('../../static/group/bg-bannermb.png');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
    width: 100%;
