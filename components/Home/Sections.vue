                            ...
                            <v-slide-item v-for="n in 10" :key="n" v-slot="{ active, toggle }">
                                <v-card class="mx-5 px-5 my-2" width="400" :color="active ? 'rgba(9, 187, 174, 1)' : 'white'">
                                    <v-card-text @click="toggle">
                                        <p class="text-h5 text-uppercase text-center font-weight-bold mt-5" :class="{'black--text': active===true , 'deep-purple--text lighten-2--text': active === false }">
                                            Criser
                                        </p>
                                        <p class="ma-0 text-h6 text-center" :class="{'black--text': active===true , 'deep-purple--text lighten-2--text': active === false }">
                                            Juan Carlos Aguirre Palomo
                                        </p>
                                        <p class="ma-0 text-center" :class="{'black--text': active===true , 'deep-purple--text lighten-2--text': active === false }">Jefe de Planeación y Compras</p>
                                        <div class="text--primary text-center">
                                            <v-icon :color="active ? 'white' : 'teal'" >mdi-star</v-icon>
                                            <v-icon :color="active ? 'white' : 'teal'">mdi-star</v-icon>
                                            <v-icon :color="active ? 'white' : 'teal'">mdi-star</v-icon>
                                            <v-icon :color="active ? 'white' : 'teal'">mdi-star</v-icon>
                                        </div>
            ...
            <v-container>
                <v-row justify="center" class="mt-10">
                    <v-col lg="6" md="6" sm="12" xs="12" align="center">
                        <h1 class="display-2 text-left">Empresa <span class="font-weight-bold purple--text">100% mexicana </span> de <span class="teal--text accent-2--text font-weight-bold">alcance mundial</span></h1>
                ...
                <v-sheet class="mx-auto my-10" max-width="1600">
                    <v-slide-group v-model="model" class="pa-4" center-active show-arrows>
                        <v-slide-item v-for="(item, index) in blogs" :key="index" >
                            <v-card class="ma-5" max-width="325" max-height="390">
