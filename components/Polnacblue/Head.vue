<template>
    <div :class="{'bg-polnacblue': windowSize > 1129, 'bg-polnacblue-mb': windowSize < 1129 }" v-if="pagePolnacBlue !== null" :style="{ backgroundImage: `url(${basePathApiUrl + pagePolnacBlue.banner.image.data[0].attributes.url })` }">
        <v-row justify="center">
            <v-col cols="12" align="center">
                <!--<h1 class="mt-16 font-archivo font-size-40 white--text font-weight-bold">POLNAC Blue</h1>-->
                <h1 class="mt-16 font-archivo font-size-40 white--text font-weight-bold" v-html="pagePolnacBlue.banner.title"></h1>
            </v-col>
            <v-col cols="10" xl="5" lg="6" md="6" sm="10" xs="10" align="center">
                ...
                <div class="title white--text mt-10 mb-16" v-html="pagePolnacBlue.banner.subtitle"></div>
            </v-col>
        </v-row>
    </div>
</template>
