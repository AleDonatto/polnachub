export default {
    async getPageHome({commit, state}){
        ...
        if(state.lang === 'eng')
            ...
            pageData = await this.$axios.$get(`https://crm.polnac.com/api/home?populate[banner][populate]=%2A&populate[featured][populate]=%2A&populate[tecOffices][populate]=%2A&populate[alliances][populate]=%2A&populate[blog][populate]=%2A&populate[appointment][populate]=%2A&populate[imgOffices][populate]=%2A&locale=es-MX`)
